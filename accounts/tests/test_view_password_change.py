...
class PasswordChangeTests(TestCase):
	...
	def test_form_inputs(self):
		'''
		The view must contain foru inputs: csrf, old_password, newpassword1, newpassword2
		'''
...
class PasswordChangeTestCase(TestCase):
	...
	'''
	Base test case for form proccessing
...
class SuccessfulPasswordChangeTests(PasswordChangeTestCase):
	...
	def test_password_changed(self):
		'''
		refresh the user instance from datadase to get the newpassword
...
class InvalidPasswordChangeTests(PasswordChangeTestCase):
	...
	def test_didnt_change_password(self):
		'''
		refressh the user instance from the database
